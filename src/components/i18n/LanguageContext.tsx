...
const translations: Record<string, Record<string, string>> = {
  th: {
    ...
    'footer.address': '254 ถนนพญาไท แขวงวังใหม่<br>เขตปทุมวัน กรุงเทพฯ 10330<br><br>โทร: 0-2218-2400<br>อีเมล: <a href="mailto:studentaffairs.edu@chula.ac.th" class="hover:text-primary">studentaffairs.edu@chula.ac.th</a>',
    ...
    'footer.copyright': 'Copyright © 2025 Faculty of Education, Chulalongkorn University',
    /* ── Scroll to top ── */
    ...
    'index.about.kicker': 'เกี่ยวกับเรา',
    'index.about.h2': 'กลุ่มภารกิจ<br><em class="text-primary not-italic">กิจการนิสิต</em>',
    ...
    'about.intro.h2': 'มุ่งพัฒนา<em class="text-primary not-italic">นิสิต</em><br>ในทุกมิติ',
    ...
    /* ── activities.html ── */
    'activities.breadcrumb.current': 'ประชาสัมพันธ์',
    'activities.h1': 'ประชาสัมพันธ์',
    'activities.subdesc': 'กิจกรรมเพื่อการเรียนรู้ พัฒนาตนเอง และสร้างความสัมพันธ์ในคณะ',
    'activities.h2': 'กิจกรรมนิสิต',
    'activities.cat.all': 'ทั้งหมด',
    'activities.cat.news': 'ข่าวสาร',
    'activities.cat.highlights': 'Highlights',
    'activities.cat.calendar': 'ปฏิทินกิจกรรม',
    'activities.cat.student': 'กิจกรรมนิสิต',
    'activities.cat.announcements': 'ประกาศคณะ',
    'activities.readMore': 'อ่านเพิ่มเติม',
    ...
    'staff.h2': 'บุคลากรของเรา',
    'staff.cat.all': 'ทั้งหมด',
    'staff.cat.admin': 'งานบริหารและประสานงาน',
    'staff.cat.welfare': 'งานสวัสดิการนิสิต',
    'staff.cat.development': 'งานกิจกรรมและพัฒนานิสิต',
    ...
    'contact.info.h2': 'ร่วมสร้าง <em class="text-primary not-italic">สังคมแห่งการเรียนรู้</em> ไปกับเรา',
  ...
  en: {
    /* ── Navigation ── */
    'logo.main': 'Student Affairs',
    'logo.sub': 'Faculty of Education, Chulalongkorn University',
    'nav.home': 'Home',
    'nav.about': 'About Us',
    'nav.scholarships': 'Welfare',
    'nav.staff': 'Staff',
    'nav.projects': 'Projects',
    'nav.activities': 'Public Relations',
    'nav.contact': 'Contact',
    'nav.login': 'Login',
    ...
    'footer.address': '254 Phayathai Road, Wang Mai<br>Pathum Wan, Bangkok 10330<br><br>Tel: 0-2218-2400<br>Email: <a href="mailto:studentaffairs.edu@chula.ac.th" class="hover:text-primary">studentaffairs.edu@chula.ac.th</a>',
    ...
    'index.about.kicker': 'About Us',
    'index.about.h2': 'Student Affairs<br><em class="text-primary not-italic">Mission Group</em>',
    ...
    'about.intro.h2': 'Committed to Developing<br><em class="text-primary not-italic">Students</em> in All Dimensions',
    ...
    /* ── activities.html ── */
    'activities.breadcrumb.current': 'Public Relations',
    'activities.h1': 'Public Relations',
    ...
    'activities.cat.all': 'All',
    'activities.cat.news': 'News',
    'activities.cat.highlights': 'Highlights',
    'activities.cat.calendar': 'Calendar',
    'activities.cat.student': 'Student Activities',
    'activities.cat.announcements': 'Announcements',
    ...
    'staff.h2': 'Our Team',
    'staff.cat.all': 'All Staff',
    'staff.cat.admin': 'Administration & Coordination',
    'staff.cat.welfare': 'Student Welfare',
    'staff.cat.development': 'Activities & Development',
    ...
    'contact.info.h2': 'Join Us in Building <em class="text-primary not-italic">a Learning Society</em>',
...
export const LanguageProvider = ({ children }: { children: React.ReactNode }) => {
  const [lang, setLangState] = useState<string>("th");

  useEffect(() => {
    // Client-side initialization from localStorage
    const savedLang = localStorage.getItem("siteLang");
    if (savedLang && (savedLang === "th" || savedLang === "en")) {
      // Use a small delay to avoid cascading render warning during hydration
